...
def factorial(n):
    ...
    #    return n
    #else:
    #    return n*factorial(n-1) dammit I wanted to use recursion
    a = 1
    for k in range(n-1):
        a *= n-k
    return a
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 49
    answer = count_cosines_from(3, 120, 0.19)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 18
    answer = count_cosines_from(1, 20, -1.35)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 0
    answer = count_cosines_from(5, 7, 0.54)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(1, 10, 0.81)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 15
    answer = count_cosines_from(5, 110, 0.9)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.358409  # This is APPROXIMATELY the correct answer.
